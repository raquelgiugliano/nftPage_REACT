...
export function Banner() {
  return (
    <Section>
      ...
      <Title>Adquiere el curso de React</Title>
      <BtnContainer>
        <a href="https://www.udemy.com/course/react-intensivo-desde-cero-y-actualizado-para-principiantes/learn/lecture/34742654#overview" target="_blank">
            <JoiNow>
                Adquirir
            </JoiNow>
        </a>
